...
me=0.3*m0;
n_l=3; %number of leads

%% Set simulation spatial properties
nx=41; %number of mesh points along x axis
ny=81; %number of mesh points along y axis
...
nl_1=41; %width of the lead #1
nl_2=41; %width of the lead #2
nl_t=nl_1+nl_2;
...
%% Plot S-matrix
fig=fig+1; figure(fig); hold off;
plot(EE/eV,abs(S11),'-r','LineWidth',2);
xlim([min(EE/eV),max(EE/eV)]);
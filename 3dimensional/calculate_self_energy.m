...
% for i=1:nl_3
%     % wave-vector for lead #3
%     ka_3=acos(+(1-(EE(i_E)-E_3(i))/2/t0));
%     Sigma(nl_1+nl_2+i,nl_1+nl_2+i)=-t0*exp(1i*ka_3)+t0;
%     Sigma_3(nl_1+nl_2+i,nl_1+nl_2+i)=-t0*exp(1i*ka_3)+t0;
% end;
...
% Gamma_3=1i*(Sigma_3-ctranspose(Sigma_3));
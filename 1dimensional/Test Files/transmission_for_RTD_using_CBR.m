%% This program calculates the transmission coefficient through a 1D RTD diode using contact block reduction (CBR) method
...
plot(E/eV,real(TM),'b','LineWidth',2);
xlim([0 0.8]);
xlabel('Transmission');
% set(gca,'Fontsize',[24]);
